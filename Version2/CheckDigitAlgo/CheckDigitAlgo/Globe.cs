...
namespace CheckDigitAlgo
{
    ...
    {
        public static Boolean CheckDigitInnove(Int32 accountNo) //innove
        {
            try
            {
        ...
        public static Boolean CheckDigitGlobeHandy(Int32 accountNo) //globe
        {
            try
            {
        ...
        public static Boolean CheckDigitVeco(String accountNo) //veco
        {
            try
            {
        ...
        public static Boolean CheckAlgoGlobe10Digits(String accountNo) //globe 10digits
        {
            try
            {
        ...
        public static Boolean CheckAsialink(String pn) //asialink
        {
            try
            {
        ...
        public static Boolean CheckDigitPLDT(String accountno) //pldt
        {
            try
            {

                var weight = new[] { 4, 3, 2, 7, 6, 5};
                var sum = 0;
                var counter = 0;

                foreach (var value in Get9Digits(accountno).ToCharArray())
                {
                    if (counter < 6)
                    {
                        sum = (int)(sum + char.GetNumericValue(value) * weight[counter]);
